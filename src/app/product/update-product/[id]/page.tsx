        ...
        isLoading || loader ? (
          <div className='w-full  flex-col h-96 flex items-center justify-center '>
            <TailSpin
              ...
              visible={true}
            />
            <p className='text-sm mt-2 font-semibold text-orange-500'>updating product   ....</p>
          </div>
        ) : (
          ...
          <div className='w-full h-full flex items-start justify-center'>
            <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg  py-2 flex-col ">
              <div className="form-control w-full max-w-full">
                ...
                <select   {...register("categoryID", { required: true })} defaultValue={'Pick a category'} className="select select-bordered">
